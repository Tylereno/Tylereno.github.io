...
/**
 * PROGRAM: ark-mobile-nomadic
 * MISSION: Nomadic RV living platform - Multi-day autonomy
 * TIER: tier-4-civil
 */

logger.info(`🚀 VITO Core v4.6.6: Booting ark-mobile-nomadic...`);

// ============================================================================
// POWER ORCHESTRATION CASCADE
// Defines which containers to freeze/thaw at battery threshold levels
// ============================================================================
const sheddingCascade = { 75: ['plex', 'jellyfin', 'media-heavy'], 50: ['nextcloud', 'file-sync'], 30: ['home-assistant-ui'], 15: ['analytics'] };
...
async function initializeAgents() {
    ...
    try {
        ...
        agentInstances.stow = new StowAgent({
            logger,
            storagePath: '/data/bus-telemetry',
...
async function main() {
    try {
        ...
        logger.info('✨ ark-mobile-nomadic is AUTONOMOUS and monitoring...');
    } catch (error) {
